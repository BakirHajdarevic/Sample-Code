...
# Program: main.py
# Description: This program was written as part of the Internet of
# Things final project. This is the GUI for the Kiosk portion of the
# project.
# Functionality: The GUI functions as the following:
#    1) Acquires an image of the environment using an USB camera.
#    2) Attempts to identify a user using Microsoft cognitive.
#    3) If user found, program loads a user's personalized ad images
#	and then records the number of ads observed by the user.
#    4) The program returns when the user opts to quit.
####################################################################
