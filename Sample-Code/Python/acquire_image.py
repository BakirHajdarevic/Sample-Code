...
# Program: acquire_image.py
# Date: 4/28/2018
# Description: This program acquires an image using any regular usb
# camera and attempts to identify an individual(s) using Microsoft's
# Cognitive API.
####################################################################
