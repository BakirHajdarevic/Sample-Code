...
# Program: environmental_monitoring.py
# Date: 4/27/2018
# Description: This program is for a Raspberry Pi 3 that 
# acquires data from two sensors and updates those values on
# on FireStore. The program is meant to run indefinitely and
# may acquire information from FireStore regarding the rate that
# information is updated to the cloud.
# 
# Sensors:
#        + BME280 - collectes humidity and temperature
#        + proximal infared sensor - acquires traffic/motion 
#			             information
#############################################################
